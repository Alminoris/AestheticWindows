...
public class BaseWindowBlock extends YAxisRotatedBlock
{
    ...
    public static final EnumProperty<GlassColor> GLASS_COLOR = EnumProperty.of("glass_color", GlassColor.class);
    ...
    public BaseWindowBlock(Settings settings)
    {
    ...
    private boolean isWindow(WorldAccess world, BlockPos pos, Direction facing)
    {
        ...
        return state.getBlock() instanceof BaseWindowBlock && state.get(FACING) == facing;
    }
}