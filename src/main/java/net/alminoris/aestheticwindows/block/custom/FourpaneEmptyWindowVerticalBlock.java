...
public class FourpaneEmptyWindowVerticalBlock extends YAxisRotatedBlock
{
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit)
    {
        ...
        while (!stack.isEmpty())
        {
                    ...
                    currentState.get(FACING) == facing)
            {
                ...
                Variant currentVariant = currentState.get(FourpaneEmptyWindowVerticalBlock.VARIANT);
